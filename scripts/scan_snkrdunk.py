...
SET_RANGES = {
    ...
    # メガシンフォニア。M1Lと同日発売でapparel IDも**同じバッチに交互に**入っている
    # （M1L 657361-364 の直後が M1S 657365-366、M1L 664095以降の直前が M1S 664090-092）。
    # アンカーはWeb検索で取得: 087=657365 / 089=657366 / 092=663661 / 078=664090 / 088=664092
    # 645xxx帯には主弾(C/U/R/RR)とARが混在（645379=フーディンR038, 645380=フーディンAR071）。
    # 664111以降はM1Lの664095-664110の直後に続くM1SのSR帯（664121=なかよしポフィンSR081）。
    # 662218=インテレオンAR069 を含む帯。残った デリバードAR074 / メガガルーラexSR080 /
    # ふしぎなアメSR082 はここか、まだ見つかっていないバッチにいる。
    'M1S': [(657365, 657400), (663639, 663680), (664080, 664094), (645320, 645440), (664111, 664160),
            (662180, 662280)],
}
CODE_TO_BOX = {'M2a': 'mega_dream_ex', 'M2': 'inferno_x', 'M4': 'ninja_spinner', 'M5': 'abyss_eye', 'M3': 'munikiss_zero', 'M1L': 'mega_brave', 'M1S': 'mega_symphonia'}
